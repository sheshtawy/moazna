...
class TestLedger(unittest.TestCase):
    ...
    def test_get_account_balance(self):
        ...
        payer_balance = self.sample_ledger.get_account_balance('mr payer', '2017-09-02')
        recipient_balance = self.sample_ledger.get_account_balance('mr recipient', '2017-09-02')
    ...
    def test_record_txn(self):
        ...
        payer_balance = self.sample_ledger.get_account_balance('mr payer', '2017-09-01')
        recipient_balance = self.sample_ledger.get_account_balance('mr recipient', '2017-09-01')
